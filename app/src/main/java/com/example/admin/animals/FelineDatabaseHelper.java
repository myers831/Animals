...
public class FelineDatabaseHelper extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 5;
    public static final String DATABASE_NAME = "Felines.db";

    public static final String TABLE_NAME = "Feline";
    ...
    public FelineDatabaseHelper(Context context) {
